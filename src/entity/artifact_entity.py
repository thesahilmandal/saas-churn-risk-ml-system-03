...
class MonitoringArtifact:
    live_data_file_path: str
    current_stats_file_path: str
    ...
    def __str__(self) -> str:
        return (
            "\nMonitoringArtifact(\n"
            f"  live_data_file_path        = {self.live_data_file_path}\n"
            f"  current_stats_file_path    = {self.current_stats_file_path}\n"
